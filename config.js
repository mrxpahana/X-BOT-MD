...
const SESSION_ID = process.env.SESSION_ID |const fs = require('fs');
const dotenv = require('dotenv');
const { Sequelize } = require('sequelize');
if (fs.existsSync('config.env')) {
  dotenv.config({
...
const ALIVE = process.env.ALIVE || "I am Alive";
const HANDLERS = process.env.HANDLER || "^";
const SESSION_ID = process.env.SESSION_ID |A-S-W-I-N-S-P-A-R-K-Y:94cf5327664580800f2811988dc69f90| "";
const SUDO = process.env.SUDO || '±94786032643';
